...
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.Default.FuzzyGraph;
...
//		context.log("Performing statistical cleanup of graph...", MessageLevel.NORMAL);
...
//		context.log("...done!", MessageLevel.NORMAL);
//		context.log("Deleted " + delNodeCounter + " nodes.", MessageLevel.NORMAL);
//		context.log("Attenuated " + attNodeCounter + " nodes.", MessageLevel.NORMAL);
//		context.log("Deleted " + delLinkCounter + " links.", MessageLevel.NORMAL);
//		context.log("Attenuated " + attLinkCounter + " links.", MessageLevel.NORMAL);
	}
