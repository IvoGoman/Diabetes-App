...
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.AggregateBinaryMetric;
...
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.CorrelationBinaryLogMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.DataTypeCorrelationMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.DataValueCorrelationMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.DistanceSignificanceMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.EndpointCorrelationMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.FrequencySignificanceMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.OriginatorCorrelationMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.ProximityCorrelationMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.SignificanceBinaryDerivateMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.binary.SignificanceBinaryLogMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.trace.TraceMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.unary.AggregateUnaryMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.unary.FrequencySignificanceUnaryMetric;
import uni.mannheim.teamproject.diabetesplaner.DataMining.FuzzyMiner.metrics.unary.RoutingSignificanceMetric;
...
public class MetricsRepository {
	 ...
	 */
		...
		public void apply(XLog log, Attenuation att, int maxRelationDistance)
			...
			scanner.scan(log, this, att, maxRelationDistance);
